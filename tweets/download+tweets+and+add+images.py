...
for screen_name in screen_names[:1]:
    ...
    for tweet in alltweets:
        ...
        ttext=zip(cleaned_text, text_from_picture)
    ...
    outputfile = '/home/linda/manifestos-oud/tweets/downloads/NL/Party leaders/test/{}_{}_tweets_images.csv'.format(screen_name,lidmaatschap[screen_name])
...
#NU ALLEEN CHECKEN OF HIJ OOK DIE TEKST JUIST HEEFT GEMERGD EN ANDERS FOEFJE VERZINNEN. DAARNA DE HELE RAMBAM
